...
public class EducationBeanDao extends DBSupport<EducationBean> implements DaoPattern<EducationBean> {
    ...
    protected static final String columnNames = "EDUCATION_ID, INSTITUTE_NAME, DEGREE_NAME, STARTDATE, ENDDATE, ED_DESCRIPTION";
    ...
    protected EducationBean RsToBean(ResultSet rs) throws SQLException {
        ...
        education.setDescription(rs.getString("ED_DESCRIPTION"));
        return education;
    }
